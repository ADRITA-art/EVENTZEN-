    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--color-surface)' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
          <img src="/logo.png" alt="EventZen Logo" style={{ width: '36px', height: '36px', borderRadius: '8px' }} />
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontFamily: 'Manrope,sans-serif', fontWeight: 800, fontSize: '1.125rem', color: '#1E3A8A', lineHeight: '1.2' }}>
              EventZen
            </span>
            <span style={{ fontSize: '0.6rem', color: '#434655', fontWeight: 600, letterSpacing: '0.02em', whiteSpace: 'nowrap' }}>
